  ...
  const recruiterStats = [
    ...
    return (
      ...
      <Button
            ...
            color="primary"
            aria-label="Add"
            className="fixed bottom-8 right-8 w-14 h-14 rounded-full bg-violet-600 hover:bg-violet-700 shadow-xl z-50"
            onClick={() => setIsModalOpen(true)}
          >
            <Plus className="w-8 h-8" />
          </Button>

          <NewJobPostForm isOpen={isModalOpen} company={company}
                onClose={() => setIsModalOpen(false)}></NewJobPostForm>
